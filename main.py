...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', '-m', choices=['2d', '3d', '2D', '3D'], help='Switch between 2D mode and 3D mode. When '
    ...
    parser.add_argument('--multiprocessing', '-m', choices=['y', 'n'], default='y', help='Switch multiprocessing off/on. Parallel '
                                                                            ...
                                                                            'taking more than a couple seconds but needs'
